...
const Landing = () => {
  ...
  return (
    <div className="text-center">
      ...
      <div className="text-center">
        {/* Hero Section */}
        <section className=" text-white px-6 py-12 bg-[#42675D] h-[850px]">
          <div className="mx-16 mx-auto flex flex-col md:flex-row items-center  rounded-[50px]">
            <div className="flex-1 text-left ml-12">
              <h1 className="text-[50px] my-3 font-bold leading-tight">
                Fulfillment Andalan
              </h1>
              <h1 className="text-[50px] my-3 font-bold leading-tight">
                Petani untuk Tingkatkan
              </h1>
              <h1 className="text-[50px] my-3 font-bold leading-tight">
                Penyimpanan Produk
              </h1>
              <p className="text-lg mt-4">
                Fokus kembangkan bisnismu di kawasan strategis tanpa perlu
              </p>
              <p className="text-lg">
                terbebani masalah operasional yang mahal dengan aglostok
              </p>
            </div>
        ...
        <section className="bg-white py-8 px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-4 mb-8">
              Kami bantu otomasi produkmu mulai penyimpanan, baik untuk kamu
              para UMKM hingga korporasi skala besar
            </p>
            <div className="flex flex-col md:flex-row items-center mt-16 md:space-x-8">
              ...
              <div className="flex-1 text-left mt-8 md:mt-0">
                ...
                <p className="text-gray-600 mt-2">
                  Kapanpun dan dimanapun, Gudang Online Aglostok siap membantu
                  operasional produk kamu dari proses pemasukan produk sampai
                  pengeluaran
                </p>
              </div>
            </div>
        ...
        <section className="bg-white py-8 px-8 mt-24 pb-20">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-600 mt-4 mb-8">
              Kami mengerti apa yang paling kamu butuhkan untuk mengelola
              produkmu
            </p>
            ...
            <div className="grid grid-cols-1 mt-16 mb-32 sm:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mt-2">
                  Layanan yang dapat disesuaikan setiap kebutuhan mulai dari
                  penyimpanan digital
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 mt-2">
                  Kombinasi dari teknologi canggih & sistem yang mudah
                  dimengerti
                </p>
              </div>
            </div>
      ...
      >
        ...
        <div  style={{ marginTop: "-50px", marginBottom: "20px" }}>
          ...
          >
            ...
            >
              <div className="text-white text-5xl font-light mt-8 pl-8 mb-6">
                Dapatkan Berita
                <br />
                Terbaru
              </div>
              <p className="pl-8 font-light text-md mb-8">
                Jadi yang pertama tahu info terbaru soal fitur, promosi, dan
                berbagai <br /> update lainnya dari AgloStok
              </p>
            </div>

            {}
            <div
              className="newsletter-input-container mr-8"
              style={{
                display: "flex",
                alignItems: "center",
