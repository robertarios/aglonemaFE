  ...
  const handleSubmit = async (e) => {
   ...
   // Validasi input
    ...
    try {
      ...
      setFieldErrors({ email: err.response?.data?.error || "Something went wrong!" });
    }
  };
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 relative font-poppins">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative flex flex-row items-center">
              <div className="flex flex-col w-full">
                ...
                {fieldErrors.fullname && (
                  <p className="text-red-500 text-sm ml-2 pl-2 w-[150px] text-left">{fieldErrors.fullname}</p>
                )}
              </div>
            </div>
             ...
             <div className="relative flex flex-row items-center">
              <div className="flex flex-col w-full">
                ...
                {/* Error Message */}
                {fieldErrors.email && (
                  <p className="text-red-500 text-sm ml-2 pl-2 w-[150px] text-left">{fieldErrors.email}</p>
                )}
              </div>
            </div>
            ...
            <div className="relative flex flex-row items-center">
              <div className="flex flex-col w-full">
                ...
                {/* Error Message */}
                {fieldErrors.phone && (
                  <p className="text-red-500 text-sm ml-2 pl-2 w-auto text-left whitespace-nowrap">{fieldErrors.phone}</p>
                )}
              </div>
            </div>
            ...
            <div className="relative flex flex-row items-center">
              <div className="flex flex-col w-full">
                ...
                {fieldErrors.password && (
                  <p className="text-red-500 text-sm ml-2 pl-2 w-[250px] text-left">{fieldErrors.password}</p>
                )}
              </div>
            </div>
            ...
            <div className="relative flex flex-row items-center">
              <div className="flex flex-col w-full">
                ...
                {fieldErrors.confirmPassword && (
                  <p className="text-red-500 text-sm ml-2 pl-2 w-auto text-left whitespace-nowrap">{fieldErrors.confirmPassword}</p>
                )}
              </div>
            </div>
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div className="bg-white p-6 rounded-lg shadow-lg text-center">
          <h2 className="text-green-700 text-2xl font-semibold mb-4">Sign Up Successful!</h2>
          <p className="text-gray-600">You have successfully created an account.</p>
